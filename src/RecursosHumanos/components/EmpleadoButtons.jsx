...
const EmpleadoButtons = ({ onAdd, onEdit, onDelete, onVacaciones, onPermiso, onIncapacidad, onDiaEconomico,onFormacion,isAddDisabled ,isEditDisabled, isDeleteDisabled, isVacacionesDisabled, isPermisoDisabled, isIncapacidadDisabled, isDiaEconomicoDisabled,isFormacionDisabled }) => {
  return (
    <div style={{ marginBottom: '20px' }}>
      <Button startIcon={<PersonAdd/>} onClick={onAdd}  disabled={isAddDisabled} >Agregar</Button>
